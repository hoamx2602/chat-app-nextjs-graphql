          ...
          >
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                data-te-ripple-init
                data-te-ripple-color="light"
                className="mr-3 inline-block bg-gray-800 rounded px-3 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg motion-reduce:transition-none"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4"
