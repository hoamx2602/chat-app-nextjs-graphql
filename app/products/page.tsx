...
import ProductPagination from '@/components/products/ui/pagination';
import ProductHead from '@/components/products/ui/product-head';
import EditProduct from '@/components/products/update-product';
